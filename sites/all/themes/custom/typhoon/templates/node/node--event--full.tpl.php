...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content-sidebar__sidebar">
    <div class="box-info bg-blue">
      <div class="box-info__datetime">
        <h2 class="title"><?php print t('Date & Time'); ?></h2>
      ...
      <div class="box-info__zone">
        <h2 class="title"><?php print t('Location'); ?></h2>
        <div class="zone"><a href="/attractions?zone=<?php print $zone; ?>" ><?php print render($content['field_zone']); ?></a></div>
      </div>
      <div class="box-info__deal">
        <h2 class="title"><?php print t('Deals'); ?></h2>
        <ul>
          <li class="preformance"><?php print t('preformance'); ?></li>
          <li class="family"><?php print t('Family'); ?></li>
          <li class="person"><?php print t('Person with disability'); ?></li>
        </ul>
      </div>
